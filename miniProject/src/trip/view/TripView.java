...
import trip.controller.TripAllController;
...
public class TripView {
	...
	private TripAllController tac = new TripAllController();
	...
	public void signIn() {
		tac.signInNew();
		System.out.println(tac.signInfo());
	}

	public void myFlight() {
		tac.myFlights();
		System.out.println(tac.myFlights());
